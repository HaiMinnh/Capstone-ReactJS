...
const Profile = () => {
  return (
    <div className='profile container mt-5'>
      <h1 className='ps-4 w-50 bg-danger'>Profile</h1>
        ...
        <div className="row">
          ...
          <div className="col-4 mt-4">
            ...
            <div className='group d-flex mt-2' style={{ width: 443 }}>
              ...
              <button className='btn rounded-5 mt-2 text-white px-4 py-1.5' type='submit' style={{ background: '#6200ee', marginLeft: 180 }}>Update</button>
            </div>
          </div>
        </div>
      </form>
      ...
      <div className='item-cart mt-5'>
        <p className='ms-5 ps-5'>+ Orders have been placed on 09 - 19 - 2020</p>
        <table style={{ width: 1200, marginLeft: 95 }} className='text-start'>
      ...
      <div className='item-cart pb-5'>
        <p className='ms-5 ps-5 pt-5'>+ Orders have been placed on 09 - 19 - 2020</p>
        <table style={{ width: 1200, marginLeft: 95 }} className='text-start'>
          <thead className="table-header mt-2" style={{ background: '#d9d9d9' }}>
            <tr>
              <th>id</th>
